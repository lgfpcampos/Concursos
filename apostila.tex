...
\include{estatistica}
\include{funcao-afim}
\include{geometria-plana}
\include{maximo-divisor-comum-e-minimo-multiplo-comum}
\include{matematica-financeira}
\include{potenciacao-e-radiciacao}
\include{razao-e-proporcao}
\include{regra-de-tres-simples-e-composta}
\include{raciocinio-logico}
\include{sequencias}
\include{sistemas-de-equacoes}
\include{sistemas-de-medidas}
\include{verdades-mentiras}
\end{enumerate}
